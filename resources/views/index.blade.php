...
@section('content')
<section class="bg-white flex flex-col md:flex-row justify-stretch shadow rounded max-w-2xl relative z-20 w-11/12">
    <div class="p-8">
        ...
        <article class="text-lg text-gray-800">
            <p class="mb-2">I'm a freelance full-stack web developer with experience using Laravel & React, among
                ...
                help you build something fully functional that looks and feels great - get in touch and let's work
                together :)</p>

            <p>Feel free to email me at
                <a href="mailto:{{ env('EMAIL') }}" class="text-blue-600 hover:text-blue-700 hover:underline font-bold">
