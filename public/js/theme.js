...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tinycolor2__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Css__ = __webpack_require__(30);
...
(function () {
    var albumArt = document.getElementById('album__art');
    var css = new __WEBPACK_IMPORTED_MODULE_2__Css__["a" /* default */]();

    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/image/color-palette?image_url=' + albumArt.src).then(function (_ref) {
        var data = _ref.data;
        var palette = data.palette;

        var colors = palette.map(function (_ref2) {
            var _ref3 = _slicedToArray(_ref2, 3),
                r = _ref3[0],
                g = _ref3[1],
                b = _ref3[2];

            return __WEBPACK_IMPORTED_MODULE_1_tinycolor2___default()({ r: r, g: g, b: b });
        });

        var newBackgroundColor = colors[0];
        var currentTextColor = __WEBPACK_IMPORTED_MODULE_1_tinycolor2___default()(css.get('contrasting'));

        if (!__WEBPACK_IMPORTED_MODULE_1_tinycolor2___default.a.isReadable(newBackgroundColor, currentTextColor)) {
